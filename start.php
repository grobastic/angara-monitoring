...
function mysql_feedback (){
    ...
    if (mysql_query("SELECT * FROM feedback LIMIT 1")) { echo 'Таблица <b>feedback</b> уже есть в базе!<br>'; }
        ...
        mysql_query('CREATE TABLE IF NOT EXISTS feedback (feedbackid INT AUTO_INCREMENT PRIMARY KEY NOT NULL, fid_userid INT, fid_fio TEXT(50), fid_phone TEXT (15), fid_email TINYTEXT, fid_text_message TEXT, fid_browser TEXT, fid_user_ip TEXT(12), fid_date TIMESTAMP NOT NULL, fid_info TEXT)')or die ("SQL Error: ".  mysql_error());
...
function mysql_points () {
 ...
 if (mysql_query("SELECT * FROM points LIMIT 1")) { echo 'Таблица <b>points</b> уже есть в базе!<br>'; }
    ...
    mysql_query('CREATE TABLE IF NOT EXISTS points (ptid INT AUTO_INCREMENT PRIMARY KEY NOT NULL, imei INT(20) NOT NULL, device_id INT(20) NOT NULL, timestamp_utc TIMESTAMP NOT NULL, '
            . 'latitude DECIMAL(15,13) NOT NULL, longitude DECIMAL(15,13) NOT NULL, satellites INT(2), speed INT (3), angle INT(3), gps_state TEXT(5), mcc TEXT(4), mnc TEXT(4), '
            . 'lac TEXT(5), cellid TEXT(8), state_acc TEXT(11), state_power TEXT(11), state_gps TEXT(11), state_oil TEXT(11), vin INT(5), gsm INT(3))')
    or die ("SQL Error: ".  mysql_error()); 
